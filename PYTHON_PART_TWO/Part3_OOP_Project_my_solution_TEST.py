...
##################################
test = open("Part3_OOP_Project_my_solution_TEST.txt", "a")
...
for x in range(0,101):
    ...
    while human.still_has_cards() and computer.still_has_cards():
        ...
        if decodeRankCard(h_card) > decodeRankCard(c_card):
            ...
            if human.hand.qtyCardsHand() > 1 and computer.hand.qtyCardsHand() > 1:
                ...
                if human.hand.qtyCardsHand() <= 1:
                    computer.hand.getAllCardFromTable(cardsOnTable)
                    cardsOnTable = []
                    # computer.hand.getAllCardFromTable(human.hand.cards)
                elif computer.hand.qtyCardsHand() <= 1:
                    human.hand.getAllCardFromTable(cardsOnTable)
                    cardsOnTable = []
    ...
    # if len(human.hand.cards) < 55 and len(human.hand.cards) > 40:
    #     print(human.hand.cards)
    #     print(computer.hand.cards)
    #     print(cardsOnTable)
    #
    # if len(computer.hand.cards) < 55 and len(computer.hand.cards) > 40:
    #     print(human.hand.cards)
    #     print(computer.hand.cards)
    #     print(cardsOnTable)
    ...
    test.write(str(len(human.hand.cards)) + " " + str(len(computer.hand.cards)) + " " + str(bitwaCounter) + "\n")
